    ...
    <div id="employee-viewer">
        ...
        <div class="card-deck">
                <div class="card">
                    ...
                    <div class="card-body"><span>Temp 2</span><br> <br> <span><br>
                            , UT<br></span></div>
                </div>
                <div class="card col-md-5">
                    <div class="card-body">
                        <table width="100%" class="user-table">
                            <tbody>
                                <tr>
                                    <td width="30px"><i class="icon-email"></i></td>
                                    <td width="33%"><strong>Username:</strong></td>
                                    <td> temp.2@holbrookasphalt.com </td>
                                </tr>
                                <tr>
...
export default {
    ...
    watch: {
        first_name(first_name){
            if(!first_name) {
                return this.employee.employee.first_name || "";
            }
        }
    }
